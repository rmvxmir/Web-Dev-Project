...
@Component({
  ...
  imports: [FormsModule, NgFor, NgIf, ReactiveFormsModule, NgClass, RouterLink],
...
export class HomePageComponent implements OnInit {
  ...
  featuredCars: Car[] = [
    ...
    {
      image: 'https://images.unsplash.com/photo-1568605117036-5fe5e7bab0b7?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80',
      make: 'Jeep Wrangler',
      fuelType: 'Regular',
      type: 'SUV',
      capacity: 5,
